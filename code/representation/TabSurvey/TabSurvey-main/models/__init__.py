all_models = ["LinearModel", "KNN", "DecisionTree", "RandomForest", "XGBoost", "CatBoost", "LightGBM", "ModelTree",
               "MLP", "TabNet", "VIME", "TabTransformer", "TabTransformer_our", "NODE", "DeepGBM", "RLN", "DNFNet", "STG", "NAM", "DeepFM",
               "SAINT", "DANet"]
...
def str2model(model):
    ...
    elif model == "TabTransformer_our":
        from models.tabtransformer_our import TabTransformer
        return TabTransformer
