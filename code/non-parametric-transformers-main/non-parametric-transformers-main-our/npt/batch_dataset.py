...
class NPTBatchDataset(torch.utils.data.IterableDataset):
    ...
    def batch_gen(self):
        ...
        self.missmatrix = self.data_dict['missing_matrix'][row_index_order, :]
        self.col_ips = self.data_dict['col_ips'][row_index_order, :]
        self.row_ips = self.data_dict['row_ips'][row_index_order]
    ...
    def __next__(self):
        ...
        batch_dict = {
            ...
            'missmatrix': self.missmatrix[self.row_index:self.row_index + batch_size, :] ,
            'col_ips': self.col_ips[self.row_index:self.row_index + batch_size, :] ,
            'row_ips': self.row_ips[self.row_index:self.row_index + batch_size],
            'masked_tensors': [
                col[self.row_index:self.row_index + batch_size]
