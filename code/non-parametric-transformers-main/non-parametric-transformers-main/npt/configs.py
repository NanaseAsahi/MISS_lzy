...
def build_parser():
    ...
    parser.add_argument(
        '--missingtype', type=str, default='mcar_',
        help=f'Currently supported are breast-cancer, poker-hand, '
             f'higgs, epsilon, forest-cover, boston-housing, mnist, yacht, '
             f'concrete, income, protein, cifar10.')
    parser.add_argument(
        '--missingrate', type=str, default='0.5',
        help=f'Currently supported are breast-cancer, poker-hand, '
             f'higgs, epsilon, forest-cover, boston-housing, mnist, yacht, '
             f'concrete, income, protein, cifar10.')
    parser.add_argument(
        '--imp', type=str, default='mean',
        help=f'Currently supported are breast-cancer, poker-hand, '
             f'higgs, epsilon, forest-cover, boston-housing, mnist, yacht, '
             f'concrete, income, protein, cifar10.')
    parser.add_argument(
    ...
    ###########################################################################
    parser.add_argument(
        '--exp_device', default='cuda:2', type=str,
    ...
    parser.add_argument(
        '--exp_batch_size', type=int, default=128,
    ...
    parser.add_argument(
        ...
        help='Number of total gradient descent steps. The maximum number of '
             ...
             'training).')
    parser.add_argument(
        '--exp_patience', type=int, default=5,
